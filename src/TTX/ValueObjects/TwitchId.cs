...
namespace TTX.ValueObjects
{
    public partial class TwitchId : ValueObject<string>
    {
        ...
        public static implicit operator TwitchId(string value)
        {
            return Create(value);
        }

        public static implicit operator TwitchId(int value)
        {
            return Create(value.ToString());
        }

        public static implicit operator int(TwitchId twitchId)
        {
